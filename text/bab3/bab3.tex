...
\begin{center}
	...
	\captionof{figure}{Perubahan dari Adjacency List menjadi Adjacency Matrix}
...
\begin{center}
	...
	\captionof{figure}{Proses Perhitungan Hierarchical Clustering}
	\label{fig:hc_detail_1}
\end{center}

\begin{center}
	\includegraphics[width=14cm]{img/bab_3/hc_detail_2.png}
	\captionof{figure}{Lanjutan Proses Perhitungan Hierarchical Clustering}
...
\begin{center}
	...
	\captionof{figure}{Proses pemotongan tree dan perubahan menjadi Adjacency Matrix  dengan linkage single sejumlah 3 partisi}
	\label{fig:asd}
\end{center}
...
\begin{center}
	...
	\captionof{figure}{Perbandingan dari nilai Cohesion dan nilai Coupling dengan jumlah \textit{cluster}/partisi menggunakan Single Linkage}
	\label{fig:asd}
\end{center}

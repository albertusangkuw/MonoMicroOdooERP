...
\appcaption{LAMPIRAN D}
\chapter{\\ DAFTAR ALGORITMA}
...
\begin{lstlisting}[style=mystyle, language=Python, caption={Penerapan Class Adapter}]
...
// service-10/controller/mapper_pos_category.go
...
// service-10/controller/rpc_pos_category.go
func methodPosCategorySelector(method string, body []byte, context *dto.JWTData) interface{} {
  ...
  // service-10/service/pos/create.go 

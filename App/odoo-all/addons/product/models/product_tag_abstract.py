...
class ProductTagAbstract(models.AbstractModel):
    _name = 'product.tag_abstract'
    _description = 'Product Tag Abstract RPC'
    _TABLE_NAME = "product_tag"
    _MODEL_NAME = "product.tag"
    _HOST_RPC = 'http://172.18.0.51:1323'
    _PATH_RPC = "/jsonrpc/web/dataset/call_kw/product.tag/"

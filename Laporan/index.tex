...
\begin{document}
	...
	% Sampul Laporan
	\include{text/sampul/cover}
	\include{text/sampul/cover2}
	...
	\include{text/h_pernyataan_originalitas/halaman_pengesahan_originalitas}
	
	% Halaman Pengesahan
	\include{text/h_pengesahan/halaman_pengesahan}
	
	% Halaman Publikasi
	\include{text/h_publikasi/halaman_publikasi}
	
	% Lembar Abstrak
	\phantomsection \addcontentsline{toc}{chapter}{ABSTRAK}
	\include{text/abstrak/abstrak}

	% Lembar Abstract
	\phantomsection \addcontentsline{toc}{chapter}{ABSTRACT}
	\include{text/abstrak/abstract}
	\clearpage
	
    % Kata Pengantar
	\phantomsection \addcontentsline{toc}{chapter}{KATA PENGANTAR}
	\include{text/kata_pengantar/kata_pengantar}
	...
	%\setcounter{page}{1}
	%\include{text/Tutorial Latex/Tutorial Latex}
	
	\setcounter{page}{1}
	\include{text/bab1/bab1}
	
	\setcounter{page}{1}
	\include{text/bab2/bab2}
	
	\setcounter{page}{1}
	\include{text/bab3/bab3}
	
	\setcounter{page}{1}
	\include{text/bab4/bab4}
	
	\setcounter{page}{1}
	\include{text/bab5/bab5}
...
%	\phantomsection \addcontentsline{toc}{chapter}{DAFTAR REFERENSI}
	...
	\begin{appendix}
	\include{text/lampiran/lampiran_isi}

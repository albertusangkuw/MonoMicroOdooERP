...
\begin{center}
	...
	\captionof{figure}{Waktu pembuatan \textit{call graph} dengan PyCG}
...
Module bisa memiliki banyak modul \verb|->| sub-modul(file) \verb|->| class / def / var /object. Untuk mengetahui apakah sebuah modul memilikinya maka digunakan \verb|inspect.getmember|. Hasil keluaran \verb|inspect.getmember| berupa array dimana \verb|['nama_objek', isi_object]|. 
...
\begin{center}
	...
	\captionof{figure}{Proses Optimisasi Graph dan Pembuatan \textit{Adjacency} Matrik}
...
\begin{center}
	...
	\captionof{figure}{Implementasi Perhitungan \textit{Distance} \textit{Matrix} dengan Jaccard dan Struktural Similarity}
	\label{fig:hc_1}
\end{center}
...
\begin{center}
	...
	\captionof{figure}{Perbandingan Coupling \& Cohesion menurut pendekatan \textit{Single} \textit{Linkage}}
	\label{fig:cc_single}
\end{center}
...
\begin{center}
	...
	\captionof{figure}{Perbandingan Coupling \& Cohesion menurut pendekatan \textit{Complete} \textit{Linkage}}
...
\begin{center}
	...
	\captionof{figure}{Perbandingan Coupling \& Cohesion menurut pendekatan \textit{Average} \textit{Linkage} }
	\label{fig:cc_avg}
\end{center}
...
\begin{center}
	...
	\captionof{figure}{ \textit{Architectural Diagram \textit{Microservice}} yang dibangun}
...
% Jelaskan modul  Product Product.tag, contoh yang ada hubungannya
% bagaimana penerapannya \textit{microservice} apakah hasil yang dibuat oleh  r
% Jelaskan modul  Pos  Pos Categ, ini contoh kalo hanya satu
...
Hasil proses \textit{clustering} sebelumnya mengelompokan 2 modul yaitu product dan point of sale(POS) menjadi service sendiri. Dari diagram database menunjukan bahwa memang benar model product.tag dan pos.category memiliki keterhubungan satu sama lain yaitu melalui model product.template untuk itulah mengapa 2 modules ini disatukan menjadi service yang sama.  
